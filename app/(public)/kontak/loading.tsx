...
export default function KontakLoading() {
  return (
    <div aria-busy="true" aria-label="Memuat halaman kontak">
      {/* HERO */}
      <section className="relative w-full min-h-screen sm:min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-cyan-700 via-blue-800 to-indigo-900 px-4">
