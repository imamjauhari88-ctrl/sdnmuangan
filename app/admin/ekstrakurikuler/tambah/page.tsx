...
import { getAlbumOptionsForEkskul } from "@/lib/data/admin-ekstrakurikuler";
...
export default async function TambahEkskulPage() {
  const albumOptions = await getAlbumOptionsForEkskul();
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Tambah Ekstrakurikuler</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Tambahkan kegiatan ekstrakurikuler baru
        </p>
      </div>

      <EkskulForm mode="create" albumOptions={albumOptions} />
    </div>
  );
}
